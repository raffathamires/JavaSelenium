...
public class DTProduto {
	...
	private boolean produtoPesquisadoNaLista(){
		return driver.findElement(By.cssSelector(".lst.lst-bordered.prod-list-view")).getText().contains(descricaoprodutoPesquisado);
	}
	@Parameters
	...
	public void testRealizaBusca() throws InterruptedException {
		...
		realizarBusca();
		Thread.sleep(3000);
		assertTrue("Deveria ter retornado o produto da lista: ", produtoPesquisadoNaLista());
		acionarVoltar();
	}
